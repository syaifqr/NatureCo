            ...
            <div class="line">
              <div class="margin">
                <div class="s-12 m-12 l-4 margin-m-bottom">
                  <a class="image-hover-zoom margin-bottom" href="/"><img src="<?=ASSETS?>/NatureCo/img/amir-rabiee-lHSZxLa29DU-unsplash.jpg" alt="" style="height: 230px;"></a>
                ...
                <div class="s-12 m-12 l-4 margin-m-bottom">
                  <a class="image-hover-zoom margin-bottom" href="/"><img src="<?=ASSETS?>/NatureCo/img/fernando-meloni-j_gnGCDQRew-unsplash.jpg" alt="" style="height: 230px;"></a>
                ...
                <div class="s-12 m-12 l-4 margin-m-bottom">
                  <a class="image-hover-zoom margin-bottom" href="/"><img src="<?=ASSETS?>/NatureCo/img/rizknas-tqvF1JXzOxs-unsplash.jpg" alt="" style="height: 230px;"></a>
          ...
          <section class="section-top-padding background-white">
            <div class="line">
              ...
              <div class="carousel-blocks owl-carousel">                                                                                                            
                <div class="item">                                                                                                                                                                                                     
                  <div class="padding">
                    <img class="full-img border-image border-primary" src="<?=ASSETS?>/NatureCo/img/team-01.jpg" alt="" title="Team" />
                ...
                <div class="item">                                                                                                                                                                                                     
                  <div class="padding">
                    <img class="full-img border-image border-primary" src="<?=ASSETS?>/NatureCo/img/team-02.jpg" alt="" title="Team" />
                ...
                <div class="item">                                                                                                                                                                                                     
                  <div class="padding">
                    <img class="full-img border-image border-primary" src="<?=ASSETS?>/NatureCo/img/team-03.jpg" alt="" title="Team" />
                ...
                <div class="item">                                                                                                                                                                                                     
                  <div class="padding">
                    <img class="full-img border-image border-primary" src="<?=ASSETS?>/NatureCo/img/team-04.jpg" alt="" title="Team" />
                ...
                <div class="item">                                                                                                                                                                                                     
                  <div class="padding">
                    <img class="full-img border-image border-primary" src="<?=ASSETS?>/NatureCo/img/team-05.jpg" alt="" title="Team" />
            ...
            <div class="line">      
              ...
              <div class="margin2x">                                                                                              
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                 
                  <img class="margin-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-5.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-2.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-3.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-4.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                 
                  <img class="margin-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-5.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                 
                  <img class="margin-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-1.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-2.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-3.png" alt="">                                                                                                                                                            
                </div>             
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-4.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-1.png" alt="">                                                                                                                                                            
                </div>
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img class="margin-m-bottom-40" src="<?=ASSETS?>/NatureCo/img/logo-3.png" alt="">                                                                                                                                                            
                </div>             
                <div class="s-6 m-4 l-2">                                                                                                                                                                                                   
                  <img src="<?=ASSETS?>/NatureCo/img/logo-4.png" alt="">                                                                                                                                                            
                </div>                                                                                                                                                                                              
              </div>
            </div>
          </section>
